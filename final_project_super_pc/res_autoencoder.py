...
class Decoder(tf.keras.layers.Layer):
    def __init__(self):
        ...
        self.decoder_activation1 = tf.keras.layers.LeakyReLU(negative_slope=0.2)
        ...
        self.decoder_activation2 = tf.keras.layers.LeakyReLU(negative_slope=0.2)
        ...
        self.decoder_activation3 = tf.keras.layers.LeakyReLU(negative_slope=0.2)
        ...
        self.decoder_activation4 = tf.keras.layers.LeakyReLU(negative_slope=0.2)
        ...
        self.decoder_activation5 = tf.keras.layers.LeakyReLU(negative_slope=0.2)
