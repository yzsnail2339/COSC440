...
def display_two_structures(structure1, structure2, mask):
    ...
    # plt.savefig('final_project/predict_lable_picture/predicrtVSlabel.png', format='png', dpi=600)
...
def display_test_loss_epochs(test_loss_epochs, file_name='final_project/test_loss_epochs_picture/test_loss_epochs.png'):
